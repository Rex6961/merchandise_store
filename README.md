...
Полнофункциональный интернет-магазин с каталогом товаров, корзиной и возможностью оформления заказа.
Он включает в себя проект Telegram-бота, интегрированного с Django для администрирования
и использования Celery  для обработки фоновых задач, таких как рассылки.
```
```mermaid
graph TB
